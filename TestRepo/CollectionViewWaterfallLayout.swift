...
//  Based on CollectionViewWaterfallLayout by Nelson Tai
    ...
    public override func prepare() {
        ...
        for section in 0..<numberOfSections {
            ...
            */
            ...
            let width = CGFloat(collectionView.frame.size.width - sectionInset.left - sectionInset.right)
            let itemWidth = CGFloat((width - CGFloat(columnCount - 1) * CGFloat(minimumColumnSpacing)) / CGFloat(columnCount))
            ...
            */
            ...
            if headerHeight > 0 {
                ...
                top = CGFloat(attributes.frame.maxY) + CGFloat(headerInset.bottom)
            }
            ...
            */
            ...
            for idx in 0..<itemCount {
                ...
                if itemSize.height > 0 && itemSize.width > 0 {
                    itemHeight = CGFloat(itemSize.height) * itemWidth / CGFloat(itemSize.width)
                }
                ...
                allItemAttributes.append(attributes)
                columnHeights[columnIndex] = CGFloat(attributes.frame.maxY) + minimumInteritemSpacing
            }
            ...
            */
            ...
            top = columnHeights[columnIndex] - minimumInteritemSpacing + CGFloat(sectionInset.bottom)
            
            let footerHeight: CGFloat = delegate.collectionView?(collectionView, layout: self, heightForFooterInSection: section) ?? self.footerHeight
            ...
            if footerHeight > 0 {
                ...
                top = CGFloat(attributes.frame.maxY) + CGFloat(footerInset.bottom)
            }
